...
- **做任务赚积分**：点击任务卡片即可加分，支持 10 项预设任务（洗手、吃饭、刷牙、睡觉等）
- **换奖励花积分**：切换到奖励 Tab，用积分兑换动画片、零食、玩具、游乐场等奖励
- **积分不足锁定**：当前星星不够时，奖励卡片会灰显，点击会提示「积分不够哦」
- **完成次数角标**：每个任务/奖励右上角显示累计完成次数
- **动效反馈**：加分时有飘字提示、星星徽章弹跳动画；赚积分时还有撒花效果

### 积分记录

- **按日期查看**：默认显示今天的记录，顶部展示当日条数与净积分
- **周日期条**：快速切换近 7 天（及额外选中的历史日期），有记录的日期会显示小圆点
- **全部记录**：一键查看所有历史，按日期分组展示
- **日历选择**：通过日历跳转到任意日期，有记录的日期同样带标记
- **回到今天**：浏览其他日期时可快速切回今天
